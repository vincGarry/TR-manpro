<div class="modal fade" id="edit_<?php echo $row->id_customer; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit_customer.php">
				<div class="row form-group">
					<div class="col-sm-4">
						<label class="control-label" style="position:relative; top:7px;">ID Customer:</label>
					</div>
					<div class="col-sm-8">
						<input type="text" class="form-control" name="id_customer" value="<?php echo $row->id_customer; ?>" readonly>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-4">
